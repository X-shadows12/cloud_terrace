...
#define BOARD_FLASH_COGGING_MAP_MAX_SIZE   ((uint32_t) (0x6000U))

#define BOARD_HAS_DUAL_MOTOR_HW           1

#ifndef BOARD_ENABLE_DUAL_MOTOR_CONTROL
#define BOARD_ENABLE_DUAL_MOTOR_CONTROL   BOARD_HAS_DUAL_MOTOR_HW
#endif

#define BOARD_LEFT_PWM_TIMER              CTM_H759_LEFT_PWM_TIMER
#define BOARD_LEFT_PWM_AF                 CTM_H759_LEFT_PWM_AF
#define BOARD_LEFT_PWM_TIMER_CLK_MHZ      300U
#define BOARD_LEFT_PWM_TIMER_RCU          CTM_H759_LEFT_PWM_TIMER_RCU
#define BOARD_LEFT_PWM_TIMER_DBG_HOLD     CTM_H759_LEFT_PWM_TIMER_DBG_HOLD
#define BOARD_LEFT_PWM_PHASE_A_CV         CTM_H759_LEFT_PWM_PHASE_A_CV
#define BOARD_LEFT_PWM_PHASE_B_CV         CTM_H759_LEFT_PWM_PHASE_B_CV
#define BOARD_LEFT_PWM_PHASE_C_CV         CTM_H759_LEFT_PWM_PHASE_C_CV
#define BOARD_LEFT_PWM_CH0_PORT           CTM_H759_LEFT_PWM_CH0_PORT
#define BOARD_LEFT_PWM_CH0_PIN            CTM_H759_LEFT_PWM_CH0_PIN
#define BOARD_LEFT_PWM_MCH0_PORT          CTM_H759_LEFT_PWM_MCH0_PORT
#define BOARD_LEFT_PWM_MCH0_PIN           CTM_H759_LEFT_PWM_MCH0_PIN
#define BOARD_LEFT_PWM_CH1_PORT           CTM_H759_LEFT_PWM_CH1_PORT
#define BOARD_LEFT_PWM_CH1_PIN            CTM_H759_LEFT_PWM_CH1_PIN
#define BOARD_LEFT_PWM_MCH1_PORT          CTM_H759_LEFT_PWM_MCH1_PORT
#define BOARD_LEFT_PWM_MCH1_PIN           CTM_H759_LEFT_PWM_MCH1_PIN
#define BOARD_LEFT_PWM_CH2_PORT           CTM_H759_LEFT_PWM_CH2_PORT
#define BOARD_LEFT_PWM_CH2_PIN            CTM_H759_LEFT_PWM_CH2_PIN
#define BOARD_LEFT_PWM_MCH2_PORT          CTM_H759_LEFT_PWM_MCH2_PORT
#define BOARD_LEFT_PWM_MCH2_PIN           CTM_H759_LEFT_PWM_MCH2_PIN

#define BOARD_RIGHT_PWM_TIMER             CTM_H759_RIGHT_PWM_TIMER
#define BOARD_RIGHT_PWM_AF                CTM_H759_RIGHT_PWM_AF
#define BOARD_RIGHT_PWM_TIMER_CLK_MHZ     300U
#define BOARD_RIGHT_PWM_TIMER_RCU         CTM_H759_RIGHT_PWM_TIMER_RCU
#define BOARD_RIGHT_PWM_TIMER_DBG_HOLD    CTM_H759_RIGHT_PWM_TIMER_DBG_HOLD
#define BOARD_RIGHT_PWM_PHASE_A_CV        CTM_H759_RIGHT_PWM_PHASE_A_CV
#define BOARD_RIGHT_PWM_PHASE_B_CV        CTM_H759_RIGHT_PWM_PHASE_B_CV
#define BOARD_RIGHT_PWM_PHASE_C_CV        CTM_H759_RIGHT_PWM_PHASE_C_CV
#define BOARD_RIGHT_PWM_CH0_PORT          CTM_H759_RIGHT_PWM_CH0_PORT
#define BOARD_RIGHT_PWM_CH0_PIN           CTM_H759_RIGHT_PWM_CH0_PIN
#define BOARD_RIGHT_PWM_MCH0_PORT         CTM_H759_RIGHT_PWM_MCH0_PORT
#define BOARD_RIGHT_PWM_MCH0_PIN          CTM_H759_RIGHT_PWM_MCH0_PIN
#define BOARD_RIGHT_PWM_CH1_PORT          CTM_H759_RIGHT_PWM_CH1_PORT
#define BOARD_RIGHT_PWM_CH1_PIN           CTM_H759_RIGHT_PWM_CH1_PIN
#define BOARD_RIGHT_PWM_MCH1_PORT         CTM_H759_RIGHT_PWM_MCH1_PORT
#define BOARD_RIGHT_PWM_MCH1_PIN          CTM_H759_RIGHT_PWM_MCH1_PIN
#define BOARD_RIGHT_PWM_CH2_PORT          CTM_H759_RIGHT_PWM_CH2_PORT
#define BOARD_RIGHT_PWM_CH2_PIN           CTM_H759_RIGHT_PWM_CH2_PIN
#define BOARD_RIGHT_PWM_MCH2_PORT         CTM_H759_RIGHT_PWM_MCH2_PORT
#define BOARD_RIGHT_PWM_MCH2_PIN          CTM_H759_RIGHT_PWM_MCH2_PIN

#define BOARD_PWM_TIMER                   CTM_H759_PWM_TIMER
#define BOARD_PWM_AF                      CTM_H759_PWM_AF
#define BOARD_PWM_TIMER_CLK_MHZ           300U
#define BOARD_PWM_TIMER_RCU               CTM_H759_PWM_TIMER_RCU
#define BOARD_PWM_TIMER_DBG_HOLD          CTM_H759_PWM_TIMER_DBG_HOLD
...
#define BOARD_LEFT_PHASE_ADC              CTM_H759_LEFT_PHASE_ADC
#define BOARD_LEFT_PHASE_ADC_RCU          CTM_H759_LEFT_PHASE_ADC_RCU
#define BOARD_LEFT_PHASE_ADC_IDX          CTM_H759_LEFT_PHASE_ADC_IDX
#define BOARD_LEFT_PHASE_A_PORT           CTM_H759_LEFT_PHASE_A_PORT
#define BOARD_LEFT_PHASE_A_PIN            CTM_H759_LEFT_PHASE_A_PIN
#define BOARD_LEFT_PHASE_A_ADC            CTM_H759_LEFT_PHASE_A_ADC
#define BOARD_LEFT_PHASE_A_ADC_CHANNEL    CTM_H759_LEFT_PHASE_A_ADC_CHANNEL
#define BOARD_LEFT_PHASE_A_ANALOG_SWITCH  CTM_H759_LEFT_PHASE_A_ANALOG_SWITCH
#define BOARD_LEFT_PHASE_B_PORT           CTM_H759_LEFT_PHASE_B_PORT
#define BOARD_LEFT_PHASE_B_PIN            CTM_H759_LEFT_PHASE_B_PIN
#define BOARD_LEFT_PHASE_B_ADC            CTM_H759_LEFT_PHASE_B_ADC
#define BOARD_LEFT_PHASE_B_ADC_CHANNEL    CTM_H759_LEFT_PHASE_B_ADC_CHANNEL
#define BOARD_LEFT_PHASE_B_ANALOG_SWITCH  CTM_H759_LEFT_PHASE_B_ANALOG_SWITCH
#define BOARD_LEFT_PHASE_ADC_IRQ          CTM_H759_LEFT_PHASE_ADC_IRQ
#define BOARD_LEFT_PHASE_ADC_IRQHandler   CTM_H759_LEFT_PHASE_ADC_IRQHandler
#define BOARD_LEFT_PHASE_TRIGGER_OUTPUT   CTM_H759_LEFT_PHASE_TRIGGER_OUTPUT
#define BOARD_LEFT_PHASE_TRIGGER_INPUT    CTM_H759_LEFT_PHASE_TRIGGER_INPUT

#define BOARD_RIGHT_PHASE_ADC             CTM_H759_RIGHT_PHASE_ADC
#define BOARD_RIGHT_PHASE_ADC_RCU         CTM_H759_RIGHT_PHASE_ADC_RCU
#define BOARD_RIGHT_PHASE_ADC_IDX         CTM_H759_RIGHT_PHASE_ADC_IDX
#define BOARD_RIGHT_PHASE_A_PORT          CTM_H759_RIGHT_PHASE_A_PORT
#define BOARD_RIGHT_PHASE_A_PIN           CTM_H759_RIGHT_PHASE_A_PIN
#define BOARD_RIGHT_PHASE_A_ADC           CTM_H759_RIGHT_PHASE_A_ADC
#define BOARD_RIGHT_PHASE_A_ADC_CHANNEL   CTM_H759_RIGHT_PHASE_A_ADC_CHANNEL
#define BOARD_RIGHT_PHASE_B_PORT          CTM_H759_RIGHT_PHASE_B_PORT
#define BOARD_RIGHT_PHASE_B_PIN           CTM_H759_RIGHT_PHASE_B_PIN
#define BOARD_RIGHT_PHASE_B_ADC           CTM_H759_RIGHT_PHASE_B_ADC
#define BOARD_RIGHT_PHASE_B_ADC_CHANNEL   CTM_H759_RIGHT_PHASE_B_ADC_CHANNEL
#define BOARD_RIGHT_PHASE_ADC_IRQ         CTM_H759_RIGHT_PHASE_ADC_IRQ
#define BOARD_RIGHT_PHASE_ADC_IRQHandler  CTM_H759_RIGHT_PHASE_ADC_IRQHandler
#define BOARD_RIGHT_PHASE_TRIGGER_OUTPUT  CTM_H759_RIGHT_PHASE_TRIGGER_OUTPUT
#define BOARD_RIGHT_PHASE_TRIGGER_INPUT   CTM_H759_RIGHT_PHASE_TRIGGER_INPUT
...
#define BOARD_LEFT_ENC_PWM_PORT           CTM_H759_LEFT_ENC_PWM_PORT
#define BOARD_LEFT_ENC_PWM_PIN            CTM_H759_LEFT_ENC_PWM_PIN
#define BOARD_LEFT_ENC_PWM_AF             CTM_H759_LEFT_ENC_PWM_AF
#define BOARD_LEFT_ENC_PWM_TIMER          CTM_H759_LEFT_ENC_PWM_TIMER
#define BOARD_LEFT_ENC_PWM_TIMER_RCU      RCU_TIMER3
#define BOARD_LEFT_ENC_PWM_TIMER_CH       CTM_H759_LEFT_ENC_PWM_TIMER_CH
#define BOARD_LEFT_ENC_PWM_TIMER_IRQ      CTM_H759_LEFT_ENC_PWM_TIMER_IRQ
#define BOARD_LEFT_ENC_PWM_TIMER_INT      CTM_H759_LEFT_ENC_PWM_TIMER_INT
#define BOARD_LEFT_ENC_PWM_TIMER_FLAG     CTM_H759_LEFT_ENC_PWM_TIMER_FLAG
#define BOARD_LEFT_ENC_PWM_TIMER_OV_FLAG  CTM_H759_LEFT_ENC_PWM_TIMER_OV_FLAG

#define BOARD_RIGHT_ENC_PWM_PORT          CTM_H759_RIGHT_ENC_PWM_PORT
#define BOARD_RIGHT_ENC_PWM_PIN           CTM_H759_RIGHT_ENC_PWM_PIN
#define BOARD_RIGHT_ENC_PWM_AF            CTM_H759_RIGHT_ENC_PWM_AF
#define BOARD_RIGHT_ENC_PWM_TIMER         CTM_H759_RIGHT_ENC_PWM_TIMER
#define BOARD_RIGHT_ENC_PWM_TIMER_RCU     RCU_TIMER3
#define BOARD_RIGHT_ENC_PWM_TIMER_CH      CTM_H759_RIGHT_ENC_PWM_TIMER_CH
#define BOARD_RIGHT_ENC_PWM_TIMER_IRQ     CTM_H759_RIGHT_ENC_PWM_TIMER_IRQ
#define BOARD_RIGHT_ENC_PWM_TIMER_INT     CTM_H759_RIGHT_ENC_PWM_TIMER_INT
#define BOARD_RIGHT_ENC_PWM_TIMER_FLAG    CTM_H759_RIGHT_ENC_PWM_TIMER_FLAG
#define BOARD_RIGHT_ENC_PWM_TIMER_OV_FLAG CTM_H759_RIGHT_ENC_PWM_TIMER_OV_FLAG
...
#define BOARD_ENC_PWM_TIMER_OV_FLAG       CTM_H759_ENC_PWM_TIMER_OV_FLAG
